...
<div style="display:flex; flex-wrap:wrap; gap:2rem; align-items:flex-start;">
  ...
  <div style="flex:1 1 500px; min-width:500px;">
    {% include video id="FSKHfBrqStI" provider="youtube" %}
  </div>
  <!-- RIGHT: text area -->
  <div style="flex:1 1 250px; min-width:250px;">
    <h2>1st Yr Project - 3D Greybox</h2>
    <p>
...
{% include figure image_path="assets/images/Screenshots/3d_screenshot_barrel.png" alt="A screenshot taken in my Unity project, showing a barrel in a dimly lit interior." caption="Screenshot of my greybox in Unity, showing off a barrel & lighting sources." %}
  </div>
</div>
